...
include_once "col_createpdf.php";
        ...
        <div class="row">
            <div class="col mt-1">
                ...
                <form method="post" style="display: inline-block;">
                    <input type="submit" name="col_createAllPdf" value="PDF" class="btn btn-success btn-sm" data-toggle="modal"></input>
                </form>
                <form method="post" style="display: inline-block;">
